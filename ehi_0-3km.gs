...
'ehi3km=srh3km*capesfc/160000'

***** ***** Begin plotting ***** *****

*Plot 0-3km energy helicity index
'color 0 10 0.1 -kind (255,255,255,0)-(0)->lightaquamarine->green->yellow->orange->red->darkviolet->palevioletred->lightpink->peachpuff->burlywood->firebrick'
...
**** MAXVAL (Energy Helicity Index 3km)
'd amax(ehi3km, lon='%LON1', lon='%LON2', lat='%LAT1', lat='%LAT2')'
...
say result
maxval_ehi3km = math_format('%5.1f',maxval)

**** MAXVAL (Energy Helicity Index 3km)
'd amin(ehi3km, lon='%LON1', lon='%LON2', lat='%LAT1', lat='%LAT2')'
...
minval_ehi3km = math_format('%5.1f',minval)
...
'set strsiz .125'
'set font 11'
'draw string .4 8.37 0-3 km Energy Helicity Index, 10m/850mb/500mb Wind Vectors (black/red/blue; mph), Sea-Level Pressure (mb)'
*hour
'set strsiz .14'
'set string 1 r'
...
*'draw string 5.5 .3 |'
'set string 1 c'
'draw string 5.5 .3 Max Energy Helicity Index: 'maxval_ehi3km' 
'draw string 5.5 .10 |'
*minval
'set string 1 r'
'draw string 5.46 0.10 Min Pressure: 'minval_slp' mb'
*'draw string 5.46 0.30 Min Energy Helicity Index: 'minval_ehi3km' 
*maxval
'set string 1 l'
'draw string 5.6 0.10 Max Pressure: 'maxval_slp' mb'
*'draw string 5.6 0.30 Max Energy Helicity Index: 'maxval_ehi3km' 
*weathertogether.net
'set font 11'
'set strsiz .14'
'set string 11 r'
